...
<concept class="- topic/topic concept/concept " id="unique_2" topicrefclass="- map/topicref " nd:nd-id="_1003" oid="_1003" specializations="@props/deliveryTarget">
    ...
    <shortdesc class="- topic/shortdesc "/>
    <conbody class="- topic/body  concept/conbody ">
        <p class="- topic/p ">官网：<xref class="- topic/xref " format="html" href="https://www.baidu.com/" scope="external"/></p>
        <p class="- topic/p ">邮箱：</p>
        <p class="- topic/p ">电话：</p>
        <p class="- topic/p ">手机号码： </p>
        <p class="- topic/p ">地址：昆山市</p>
    </conbody>
